...
Create an object called car using the object literal notation ({}).
//Give it a make property, a model property, and a year property.
//Then give it a method called getAge. This method should take in the current year
//and return the age of the car as an integer.
*/
...
Now assign a year property to the window(global) object. Give that property the value 2000.
...
Bind the makeSound method of the animal object to the dog object. Assign this bound function to the
//variable called makeDogSound.
...
var euthanasiaList = objWithFind.findProp.call(animal, large);
// Code here
...
*/
Strong.prototype.toUpperCase("shea and brian have a love hate relatioship")
...
// Code here
Array.prototype.filter([a, b, c ], function() {return true})


/*
Apply the String.prototype.replace method and pass it a new string as context and an array which contains a value
//to search and a value to replace it with.
*/

// Code here
String.prototype.replace("nobody checks this", ["nobody", "somebody"]);

/*
10. Constructor Functions

We'll cover these again tomorrow, but because the new keyword is in this lesson, let's pratice writing a constructor
//function again.

Create a constructor function for Person. Take in the name, age, and weight of a person, and assign these values
...
Create two persons, brian and briansClone, based on your Person object. Call the change weight method for each.
